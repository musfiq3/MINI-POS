...
@section('user_content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row clearfix justify-content-md-center">
                <div class="col-md-6">
                    <div class="no_padding"><b>Supplier :</b> {{$user->name}}</div>
                ...
                <table class="table">
                    ...
                    @foreach($invoice->items as $key=>$item)
                        <tr>
                            ...
                            <td class="text-right">
                                <form method="POST" action="{{route('user.purchases.delete_item',[$user->id, $invoice->id, $item->id])}}">
    ...
    <div class="modal fade" id="newProduct" tabindex="-1" role="dialog" aria-labelledby="newProductModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" action="{{route('user.purchases.add_item',[$user->id, $invoice->id] )}}">
                @csrf
    ...
    {{-- Modal for New Payments for Invoice --}}
    ...
    <div class="modal fade" id="newPaymentForInvoice" tabindex="-1" role="dialog" aria-labelledby="newPaymentForInvoiceModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" action="{{route('user.payments.store', [$user->id, $invoice->id])}}">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
