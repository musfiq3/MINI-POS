...
Route::post('users/{id}/invoices/{invoice_id}', 'UserSalesController@addItem')->name('user.sales.add_item');
...
Route::get('reports/days',        'Reports\DayReportsController@index')->name('reports.days');
